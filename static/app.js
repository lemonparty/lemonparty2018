...
var _background_changer = __webpack_require__(332);

var _background_changer2 = _interopRequireDefault(_background_changer);

var _lemon_party = __webpack_require__(333);
...
var _photos = __webpack_require__(338);
...
var _lemon = __webpack_require__(334);
...
var _wandering_box_shadow = __webpack_require__(336);
...
var Photos = {
	init: function init() {
		var el = document.querySelectorAll(".body-photos");

		if (!el.length) {
			return;
		}

		_lazy_images2.default.init();
		this.initializeAutocomplete();
	},
	initializeAutocomplete: function initializeAutocomplete() {
		var element = document.querySelector("#photo-filter-container");
		...
		(0, _accessibleAutocomplete2.default)({
			element: element,
			id: "photo-filter",
			source: _names2.default,
			placeholder: "muxy",
			onConfirm: function onConfirm(res) {
				if (!res || _names2.default.indexOf(res) < 0) {
					return;
				}
...
var LazyImages = {
	...
	addColorToggleHandlers: function addColorToggleHandlers() {
		var _this = this;

		var toggleLinks = document.querySelectorAll(".colorToggleButton");

		Array.from(toggleLinks).forEach(function (toggleLink) {
			toggleLink.addEventListener("click", function (e) {
				e.preventDefault();
				var el = e.target.closest(".photos-photo");
				_this.toggleColor(el);
			});
		});
	},
	checkScroll: function checkScroll() {
		document.querySelectorAll(".photos-photo:not(.isLoaded)").forEach(function (image) {
			if (LazyImages.isOnScreen(image)) {
				LazyImages.loadImage(image);
			}
		});
	},
	toggleColor: function toggleColor(el) {
		var srcColor = el.getAttribute("data-image-src-color");
		var currentImage = el.querySelectorAll(".photos-photo-content")[0];
		var currentBackground = currentImage.getAttribute("style");
		var isCurrentlyColor = currentBackground.indexOf(srcColor) >= 0;
	...
	loadImage: function loadImage(el) {
		var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
		    _ref$loadGrayscale = _ref.loadGrayscale,
		    loadGrayscale = _ref$loadGrayscale === undefined ? false : _ref$loadGrayscale;

		el.classList.add("isLoading");

		var hrefColor = el.getAttribute("data-image-href-color");
		var hrefGrayscale = el.getAttribute("data-image-href-grayscale");
		var href = hrefColor || hrefGrayscale;

		var srcColor = el.getAttribute("data-image-src-color");
		var srcGrayscale = el.getAttribute("data-image-src-grayscale");
		var src = srcColor || srcGrayscale;
...
exports.default = ["laura", "kevin fi", "olivia", "paula", "adam p", "jonah", "steve", "zeev", "zeke", "becca", "adam cz", "anne", "lillie", "emily c", "jeanne g", "phil", "joanne", "owen", "chris g", "lori", "isabella", "sophia", "victor", "alison", "annie", "billy", "wallis", "marie", "larry", "max", "russ", "toast", "tom", "jeanie", "mike c", "casey", "sarah", "muxy", "stacey", "dan k", "chris m", "amy", "shelley", "chelsea", "lindsay", "jacob", "pam", "craig", "becky", "josh", "katie", "eva", "jiva", "rosalie", "kevin l", "scott", "blair", "zach", "pierre", "adrian", "henry", "bruce", "mark b", "nicole", "corey", "lucas", "marcy", "ryan", "pepper", "joe", "joanna", "jeanne t", "kim", "emily b", "nicky", "dave", "nick", "karen", "john", "clara", "tomomi", "cary", "mike g", "diana g", "travis", "elsie", "anson", "benna", "andrew", "crispen", "linda", "melissa w", "melissa h", "ashlie", "heidi", "mark l", "ray", "morley", "tracey", "kevin fo", "brandon", "dan p", "diana j", "peter", "gary", "emily n", "jake", "ben h", "ben g", "nikki", "brianna", "nicholas"];
